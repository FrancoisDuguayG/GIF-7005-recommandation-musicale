...
# Charger les données
file_path = Path('data/user_taste_profile_small.txt')
...
save_npz(Path('process_data/user_song_matrix.npz'), sparse_matrix)

matrix = load_npz(Path('process_data/user_song_matrix.npz'))
